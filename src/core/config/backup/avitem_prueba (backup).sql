...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-03-2025 a las 19:05:52
...
(63, 80, '2025-01-27', 25, 1, 0, 0, '2025-01-27', '2025-01-27', 88),
(64, 90, '2025-01-27', 17, NULL, 4, 4, '2025-01-27', '2025-01-27', 0);
...
(88, '2', '2025-01-27', 80, '2025-12-31', 17.50, 22.00, 25);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `materiales_servicio`
--
...
(17, 'Zocalo Superior Jumbo', 'Descripcion - Zocalo Superior Jumbo', 90, '2024-11-16', 'Cromo', 'A97', 1, 5, 1, 2),
...
(25, 'product x', 'xxx', 80, '2025-01-01', 'Plancha', 'micode', 1, 7, 1, 2),
...
(74, '2025-01-27', 36.00, 'tokenSIM', 2, 5, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `venta_combo`
--
...
--
-- Indices de la tabla `materiales_servicio`
--
...
--
-- Indices de la tabla `venta_combo`
--
...
--
-- AUTO_INCREMENT de la tabla `materiales_servicio`
--
ALTER TABLE `materiales_servicio`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `venta_combo`
--
ALTER TABLE `venta_combo`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
-- Filtros para la tabla `materiales_servicio`
--
ALTER TABLE `materiales_servicio`
...
--
-- Filtros para la tabla `venta_combo`
--
ALTER TABLE `venta_combo`
