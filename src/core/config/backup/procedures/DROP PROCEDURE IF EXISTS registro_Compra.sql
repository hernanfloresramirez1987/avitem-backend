...
END;
    ...
    START TRANSACTION;
        ...
        WHILE i < JSON_LENGTH(p_detalle) DO
            ...
            -- Insertar el lote en 'lote_producto'
...
CALL registro_Compra_y_Detalle_mas_Lote_update_Product(
   '2025-01-12',
   3215,
   '4',  '[{"cantidad":79,"precioUnitario":35,"precioVenta":60,"id_producto":15},{"cantidad":5,"precioUnitario":90,"precioVenta":150,"id_producto":16}]',
   '2025-31-12',
   @resultado,
   @status
);
